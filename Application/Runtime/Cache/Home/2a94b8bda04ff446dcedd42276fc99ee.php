...
<header>
    ...
    <div class="bookshelf">
                ...
                <div class="modal fade" id="shuji<?php echo ($key); ?>" aria-hidden="true">
                    <div class="modal-content modal-dialog" id="shujimodal">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-primary btn-close" href="/Library_of_lovely_xin/Home/Index/indexBook?book_id=<?php echo ($bookInfo["book_id"]); ?>&page=1" target="_blank" >阅读此书</a>
        ...
        <script>
            $(function () {
                $('#sub').click(function () {
                    ...
                    $.ajax({
                        url: '/Library_of_lovely_xin/Home/UploadBook/getBook',
                        type: 'post',
                        data: formData,
                        processData: false,
                        contentType: false,
        ...
        <div class="<?php if($p > 1): ?>page-lf<?php endif; ?>">
            <a href="/Library_of_lovely_xin/Home/index/index/p/<?php echo ($p-1); ?>" class="<?php if($p < 2): ?>index-hidden<?php endif; ?>"><<</a>
            <a class="span-right <?php if($p == $pages): ?>index-hidden<?php endif; ?>" href="/Library_of_lovely_xin/Home/index/index/p/<?php if($p+1 == 1): ?>2<?php else: echo ($p+1); endif; ?>">>></a>
        </div>
    </div>
